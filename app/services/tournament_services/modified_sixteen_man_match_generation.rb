...
module TournamentServices
  class ModifiedSixteenManMatchGeneration
    ...
    def round_one(weight, rows)
      ...
      rows << create_matchup_from_seed(4, 13, 'Bracket Round of 16', 4, 1, weight)
      rows << create_matchup_from_seed(3, 14, 'Bracket Round of 16', 5, 1, weight)
    ...
    def round_five(weight, rows)
      ...
      return unless @number_of_placers >= 8
    ...
    def wrestler_with_seed(seed, weight)
      ...
      return wrestler.id if wrestler
    ...
    def create_matchup_from_seed(w1_seed, w2_seed, bracket_position, bracket_position_number, round, weight)
      ...
      create_matchup(wrestler_with_seed(w1_seed, weight), wrestler_with_seed(w2_seed, weight), bracket_position,
                     bracket_position_number, round, weight)
      # end
    end
