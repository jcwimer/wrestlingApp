...
class TournamentTest < ActiveSupport::TestCase
  ...
  test 'Tournament validations' do
    ...
    assert_equal %i[date name tournament_type address director director_email], tourney.errors.attribute_names
  end
  ...
  test 'Tournament create_pre_defined_weights High School Boys Weights' do
    ...
    Weight::HS_WEIGHT_CLASSES.split(',').each do |weight|
      assert(tournament.weights.one? { |w| w.max == weight.to_i })
    end
  end
