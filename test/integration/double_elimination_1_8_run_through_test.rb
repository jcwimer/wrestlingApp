...
class DoubleEliminationEightPlacesRunThrough < ActionDispatch::IntegrationTest
  def setup
  end
  ...
  test "16 man double elimination place 1-6" do
    create_double_elim_tournament_single_weight(14, "Regular Double Elimination 1-6")
    matches = @tournament.matches.reload
