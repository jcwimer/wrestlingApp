...
class DoubleEliminationSixtyFourManEightPlacesMatchGeneration < ActionDispatch::IntegrationTest
  ...
  test 'Match generation works for 64‐slot bracket' do
    ...
    # Winners‐bracket
    assert @tournament.matches.count { |m| m.bracket_position == 'Bracket Round of 64' } == 32
    ...
    # Losers‐bracket
    assert @tournament.matches.count { |m| m.bracket_position == 'Conso Round of 32.1' } == 16
    assert @tournament.matches.count { |m| m.bracket_position == 'Conso Round of 32.2' } == 16
  ...
  test 'Byes are advanced correctly into Round of 32' do
    ...
    match_r32_1 = @tournament.matches.find do |m|
    ...
    match_r32_15 = @tournament.matches.find do |m|
  ...
  test 'Loser names set up correctly' do
    ...
    # Round of 64 matches
    @tournament.matches.find { |m| m.bracket_position == 'Bracket Round of 64' && m.bracket_position_number == 1 }
    ...
    @tournament.matches.find { |m| m.bracket_position == 'Bracket Round of 64' && m.bracket_position_number == 32 }
    ...
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 1
    }.loser2_name == "Loser of #{match2.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 2
    }.loser1_name == "Loser of #{match3.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 2
    }.loser2_name == "Loser of #{match4.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 3
    }.loser1_name == "Loser of #{match5.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 3
    }.loser2_name == "Loser of #{match6.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 4
    }.loser1_name == "Loser of #{match7.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 4
    }.loser2_name == "Loser of #{match8.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 5
    }.loser1_name == "Loser of #{match9.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 5
    }.loser2_name == "Loser of #{match10.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 6
    }.loser1_name == "Loser of #{match11.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 6
    }.loser2_name == "Loser of #{match12.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 7
    }.loser1_name == "Loser of #{match13.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 7
    }.loser2_name == "Loser of #{match14.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 8
    }.loser1_name == "Loser of #{match15.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 8
    }.loser2_name == "Loser of #{match16.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 9
    }.loser1_name == "Loser of #{match17.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 9
    }.loser2_name == "Loser of #{match18.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 10
    }.loser1_name == "Loser of #{match19.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 10
    }.loser2_name == "Loser of #{match20.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 11
    }.loser1_name == "Loser of #{match21.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 11
    }.loser2_name == "Loser of #{match22.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 12
    }.loser1_name == "Loser of #{match23.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 12
    }.loser2_name == "Loser of #{match24.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 13
    }.loser1_name == "Loser of #{match25.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 13
    }.loser2_name == "Loser of #{match26.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 14
    }.loser1_name == "Loser of #{match27.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 14
    }.loser2_name == "Loser of #{match28.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 15
    }.loser1_name == "Loser of #{match29.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 15
    }.loser2_name == "Loser of #{match30.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.1' && m.bracket_position_number == 16
    }.loser1_name == "Loser of #{match31.bout_number}"
    ...
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 1
    }.loser1_name == "Loser of #{r32_match16.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 2
    }.loser1_name == "Loser of #{r32_match15.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 3
    }.loser1_name == "Loser of #{r32_match14.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 4
    }.loser1_name == "Loser of #{r32_match13.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 5
    }.loser1_name == "Loser of #{r32_match12.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 6
    }.loser1_name == "Loser of #{r32_match11.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 7
    }.loser1_name == "Loser of #{r32_match10.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 8
    }.loser1_name == "Loser of #{r32_match9.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 9
    }.loser1_name == "Loser of #{r32_match8.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 10
    }.loser1_name == "Loser of #{r32_match7.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 11
    }.loser1_name == "Loser of #{r32_match6.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 12
    }.loser1_name == "Loser of #{r32_match5.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 13
    }.loser1_name == "Loser of #{r32_match4.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 14
    }.loser1_name == "Loser of #{r32_match3.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 15
    }.loser1_name == "Loser of #{r32_match2.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 32.2' && m.bracket_position_number == 16
    }.loser1_name == "Loser of #{r32_match1.bout_number}"
    ...
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 8.2' && m.bracket_position_number == 1
    }.loser1_name == "Loser of #{quarter4.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 8.2' && m.bracket_position_number == 2
    }.loser1_name == "Loser of #{quarter3.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 8.2' && m.bracket_position_number == 3
    }.loser1_name == "Loser of #{quarter2.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 8.2' && m.bracket_position_number == 4
    }.loser1_name == "Loser of #{quarter1.bout_number}"
  ...
  test 'Placement points are given when moving through bracket' do
    match_semis = @tournament.matches.find do |m|
    ...
    match_conso_semi = @tournament.matches.find do |m|
    ...
    match_conso_q = @tournament.matches.find do |m|
