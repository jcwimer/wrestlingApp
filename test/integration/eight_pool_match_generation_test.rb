...
class EightPoolMatchGenerationTest < ActionDispatch::IntegrationTest
  ...
  test 'Loser names set up correctly' do
    ...
    assert @tournament.matches.find { |m| m.bracket_position == 'Quarter' && m.bracket_position_number == 1 }.loser2_name == 'Winner Pool 8'
    assert @tournament.matches.find { |m| m.bracket_position == 'Quarter' && m.bracket_position_number == 2 }.loser1_name == 'Winner Pool 4'
    assert @tournament.matches.find { |m| m.bracket_position == 'Quarter' && m.bracket_position_number == 2 }.loser2_name == 'Winner Pool 5'
    assert @tournament.matches.find { |m| m.bracket_position == 'Quarter' && m.bracket_position_number == 3 }.loser1_name == 'Winner Pool 2'
    assert @tournament.matches.find { |m| m.bracket_position == 'Quarter' && m.bracket_position_number == 3 }.loser2_name == 'Winner Pool 7'
    assert @tournament.matches.find { |m| m.bracket_position == 'Quarter' && m.bracket_position_number == 4 }.loser1_name == 'Winner Pool 3'
    assert @tournament.matches.find { |m| m.bracket_position == 'Quarter' && m.bracket_position_number == 4 }.loser2_name == 'Winner Pool 6'
