...
class DoubleEliminationSixteenManEightPlacesMatchGeneration < ActionDispatch::IntegrationTest
  ...
  test 'Seeded wrestlers have correct first line' do
    ...
    match5 = @tournament.matches.find { |match| match.round == 1 and match.bracket_position_number == 5 }
    match6 = @tournament.matches.find { |match| match.round == 1 and match.bracket_position_number == 6 }
    match7 = @tournament.matches.find { |match| match.round == 1 and match.bracket_position_number == 7 }
    match8 = @tournament.matches.find { |match| match.round == 1 and match.bracket_position_number == 8 }
  ...
  test 'Loser names set up correctly' do
    ...
    match6 = @tournament.matches.find { |match| match.round == 1 and match.bracket_position_number == 6 }
    match7 = @tournament.matches.find { |match| match.round == 1 and match.bracket_position_number == 7 }
    @tournament.matches.find { |match| match.round == 1 and match.bracket_position_number == 8 }

    assert @tournament.matches.find { |m| m.bracket_position == 'Conso Round of 8.1' && m.bracket_position_number == 1 }.loser1_name == 'BYE'
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 8.1' && m.bracket_position_number == 1
    }.loser2_name == "Loser of #{match2.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 8.1' && m.bracket_position_number == 2
    }.loser1_name == "Loser of #{match3.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 8.1' && m.bracket_position_number == 2
    }.loser2_name == "Loser of #{match4.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 8.1' && m.bracket_position_number == 3
    }.loser1_name == "Loser of #{match5.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 8.1' && m.bracket_position_number == 3
    }.loser2_name == "Loser of #{match6.bout_number}"
    assert @tournament.matches.find { |m|
      m.bracket_position == 'Conso Round of 8.1' && m.bracket_position_number == 4
    }.loser1_name == "Loser of #{match7.bout_number}"
    assert @tournament.matches.find { |m| m.bracket_position == 'Conso Round of 8.1' && m.bracket_position_number == 4 }.loser2_name == 'BYE'
    ...
    conso_r8_1_match1 = @tournament.matches.find { |match| match.bracket_position == 'Conso Round of 8.2' && match.bracket_position_number == 1 }
    conso_r8_1_match2 = @tournament.matches.find { |match| match.bracket_position == 'Conso Round of 8.2' && match.bracket_position_number == 2 }
    conso_r8_1_match3 = @tournament.matches.find { |match| match.bracket_position == 'Conso Round of 8.2' && match.bracket_position_number == 3 }
    conso_r8_1_match4 = @tournament.matches.find { |match| match.bracket_position == 'Conso Round of 8.2' && match.bracket_position_number == 4 }
