...
class DoubleEliminationSixtyFourManEightPlacesRunThrough < ActionDispatch::IntegrationTest
  ...
  test '64 man double elimination place 1-8' do
    ...
    winner_by_name('Test32', bracket_r64.find { |m| m.bracket_position_number == 2 }) # seed 32 vs seed 33
    winner_by_name('Test17', bracket_r64.find { |m| m.bracket_position_number == 3 }) # seed 17 vs seed 48
    winner_by_name('Test49', bracket_r64.find { |m| m.bracket_position_number == 4 }) # seed 16 vs seed 49
    winner_by_name('Test9', bracket_r64.find { |m| m.bracket_position_number == 5 }) # seed  9 vs seed 56
    winner_by_name('Test24', bracket_r64.find { |m| m.bracket_position_number == 6 }) # seed 24 vs seed 41
    winner_by_name('Test25', bracket_r64.find { |m| m.bracket_position_number == 7 }) # seed 25 vs seed 40
    winner_by_name('Test8', bracket_r64.find { |m| m.bracket_position_number == 8 }) # seed  8 vs seed 57
    winner_by_name('Test5', bracket_r64.find { |m| m.bracket_position_number == 9 }) # seed  5 vs seed 60
    winner_by_name('Test37', bracket_r64.find { |m| m.bracket_position_number == 10 }) # seed 28 vs seed 37
    winner_by_name('Test21', bracket_r64.find { |m| m.bracket_position_number == 11 }) # seed 21 vs seed 44
    winner_by_name('Test12', bracket_r64.find { |m| m.bracket_position_number == 12 }) # seed 12 vs seed 53
    winner_by_name('Test13', bracket_r64.find { |m| m.bracket_position_number == 13 }) # seed 13 vs seed 52
    winner_by_name('Test20', bracket_r64.find { |m| m.bracket_position_number == 14 }) # seed 20 vs 45
    winner_by_name('Test29', bracket_r64.find { |m| m.bracket_position_number == 15 }) # seed 29 vs 36
    winner_by_name('Test4',  bracket_r64.find { |m| m.bracket_position_number == 16 }) # seed 4 vs 61
    winner_by_name('Test3',  bracket_r64.find { |m| m.bracket_position_number == 17 }) # seed 3 vs 62
    winner_by_name('Test30', bracket_r64.find { |m| m.bracket_position_number == 18 }) # seed 30 vs 35
    winner_by_name('Test19', bracket_r64.find { |m| m.bracket_position_number == 19 }) # seed 19 vs 46
    winner_by_name('Test14', bracket_r64.find { |m| m.bracket_position_number == 20 }) # seed 14 vs 51
    winner_by_name('Test11', bracket_r64.find { |m| m.bracket_position_number == 21 }) # seed 11 vs 54
    winner_by_name('Test22', bracket_r64.find { |m| m.bracket_position_number == 22 }) # seed 22 vs 43
    winner_by_name('Test27', bracket_r64.find { |m| m.bracket_position_number == 23 }) # seed 27 vs 38
    winner_by_name('Test6',  bracket_r64.find { |m| m.bracket_position_number == 24 }) # seed 6 vs 59
    winner_by_name('Test7',  bracket_r64.find { |m| m.bracket_position_number == 25 }) # seed 7 vs 58
    winner_by_name('Test26', bracket_r64.find { |m| m.bracket_position_number == 26 }) # seed 26 vs 39
    winner_by_name('Test23', bracket_r64.find { |m| m.bracket_position_number == 27 }) # seed 23 vs 42
    winner_by_name('Test10', bracket_r64.find { |m| m.bracket_position_number == 28 }) # seed 10 vs 55
    winner_by_name('Test15', bracket_r64.find { |m| m.bracket_position_number == 29 }) # seed 15 vs 50
    winner_by_name('Test18', bracket_r64.find { |m| m.bracket_position_number == 30 }) # seed 18 vs 47
    winner_by_name('Test31', bracket_r64.find { |m| m.bracket_position_number == 31 }) # seed 31 vs 34
    # BYE's auto move
    ...
    assert bracket_r32.find { |m| m.bracket_position_number == 1 }.reload.wrestler1.name == 'Test1'
    assert bracket_r32.find { |m| m.bracket_position_number == 1 }.reload.wrestler2.name == 'Test32'
    winner_by_name('Test1', bracket_r32.find { |m| m.bracket_position_number == 1 })
    assert bracket_r32.find { |m| m.bracket_position_number == 2 }.reload.wrestler1.name == 'Test17'
    assert bracket_r32.find { |m| m.bracket_position_number == 2 }.reload.wrestler2.name == 'Test49'
    winner_by_name('Test17', bracket_r32.find { |m| m.bracket_position_number == 2 })
    assert bracket_r32.find { |m| m.bracket_position_number == 3 }.reload.wrestler1.name == 'Test9'
    assert bracket_r32.find { |m| m.bracket_position_number == 3 }.reload.wrestler2.name == 'Test24'
    winner_by_name('Test24', bracket_r32.find { |m| m.bracket_position_number == 3 })
    assert bracket_r32.find { |m| m.bracket_position_number == 4 }.reload.wrestler1.name == 'Test25'
    assert bracket_r32.find { |m| m.bracket_position_number == 4 }.reload.wrestler2.name == 'Test8'
    winner_by_name('Test8', bracket_r32.find { |m| m.bracket_position_number == 4 })
    assert bracket_r32.find { |m| m.bracket_position_number == 5 }.reload.wrestler1.name == 'Test5'
    assert bracket_r32.find { |m| m.bracket_position_number == 5 }.reload.wrestler2.name == 'Test37'
    winner_by_name('Test5', bracket_r32.find { |m| m.bracket_position_number == 5 })
    assert bracket_r32.find { |m| m.bracket_position_number == 6 }.reload.wrestler1.name == 'Test21'
    assert bracket_r32.find { |m| m.bracket_position_number == 6 }.reload.wrestler2.name == 'Test12'
    winner_by_name('Test21', bracket_r32.find { |m| m.bracket_position_number == 6 })
    assert bracket_r32.find { |m| m.bracket_position_number == 7 }.reload.wrestler1.name == 'Test13'
    assert bracket_r32.find { |m| m.bracket_position_number == 7 }.reload.wrestler2.name == 'Test20'
    winner_by_name('Test13', bracket_r32.find { |m| m.bracket_position_number == 7 })
    assert bracket_r32.find { |m| m.bracket_position_number == 8 }.reload.wrestler1.name == 'Test29'
    assert bracket_r32.find { |m| m.bracket_position_number == 8 }.reload.wrestler2.name == 'Test4'
    winner_by_name('Test4', bracket_r32.find { |m| m.bracket_position_number == 8 })
    assert bracket_r32.find { |m| m.bracket_position_number == 9 }.reload.wrestler1.name == 'Test3'
    assert bracket_r32.find { |m| m.bracket_position_number == 9 }.reload.wrestler2.name == 'Test30'
    winner_by_name('Test3', bracket_r32.find { |m| m.bracket_position_number == 9 })
    assert bracket_r32.find { |m| m.bracket_position_number == 10 }.reload.wrestler1.name == 'Test19'
    assert bracket_r32.find { |m| m.bracket_position_number == 10 }.reload.wrestler2.name == 'Test14'
    winner_by_name('Test19', bracket_r32.find { |m| m.bracket_position_number == 10 })
    assert bracket_r32.find { |m| m.bracket_position_number == 11 }.reload.wrestler1.name == 'Test11'
    assert bracket_r32.find { |m| m.bracket_position_number == 11 }.reload.wrestler2.name == 'Test22'
    winner_by_name('Test11', bracket_r32.find { |m| m.bracket_position_number == 11 })
    assert bracket_r32.find { |m| m.bracket_position_number == 12 }.reload.wrestler1.name == 'Test27'
    assert bracket_r32.find { |m| m.bracket_position_number == 12 }.reload.wrestler2.name == 'Test6'
    winner_by_name('Test27', bracket_r32.find { |m| m.bracket_position_number == 12 })
    assert bracket_r32.find { |m| m.bracket_position_number == 13 }.reload.wrestler1.name == 'Test7'
    assert bracket_r32.find { |m| m.bracket_position_number == 13 }.reload.wrestler2.name == 'Test26'
    winner_by_name('Test7', bracket_r32.find { |m| m.bracket_position_number == 13 })
    assert bracket_r32.find { |m| m.bracket_position_number == 14 }.reload.wrestler1.name == 'Test23'
    assert bracket_r32.find { |m| m.bracket_position_number == 14 }.reload.wrestler2.name == 'Test10'
    winner_by_name('Test23', bracket_r32.find { |m| m.bracket_position_number == 14 })
    assert bracket_r32.find { |m| m.bracket_position_number == 15 }.reload.wrestler1.name == 'Test15'
    assert bracket_r32.find { |m| m.bracket_position_number == 15 }.reload.wrestler2.name == 'Test18'
    winner_by_name('Test15', bracket_r32.find { |m| m.bracket_position_number == 15 })
    assert bracket_r32.find { |m| m.bracket_position_number == 16 }.reload.wrestler1.name == 'Test31'
    assert bracket_r32.find { |m| m.bracket_position_number == 16 }.reload.wrestler2.name == 'Test2'
    winner_by_name('Test2', bracket_r32.find { |m| m.bracket_position_number == 16 })
    ...
    assert conso_quarters.find { |m| m.bracket_position_number == 1 }.reload.wrestler1.name == 'Test16'
    assert conso_quarters.find { |m| m.bracket_position_number == 1 }.reload.wrestler2.name == 'Test6'
    winner_by_name('Test16', conso_quarters.find { |m| m.bracket_position_number == 1 })
    assert conso_quarters.find { |m| m.bracket_position_number == 2 }.reload.wrestler1.name == 'Test35'
    assert conso_quarters.find { |m| m.bracket_position_number == 2 }.reload.wrestler2.name == 'Test25'
    winner_by_name('Test35', conso_quarters.find { |m| m.bracket_position_number == 2 })
    ...
    assert (bout0_names & %w[Test1 Test16]).size == 2
    assert (bout1_names & %w[Test3 Test35]).size == 2
